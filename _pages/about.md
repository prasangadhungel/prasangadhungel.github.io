...
Currently, I work as a Machine Learning Engineer at [E.ON](https://www.eon.com/en) in Munich, where I architect end-to-end ML infrastructure on Azure, design production-grade CI/CD pipelines, and lead initiatives in MLOps and model lifecycle management. I recently completed my Master's degree in Informatics at [TUM](https://www.tum.de/en/), where my thesis explored efficient methods for pruning large-scale datasets through score extrapolation under the supervision of [Prof. Stephan Günnemann](https://www.professoren.tum.de/guennemann-stephan). My coursework spanned Deep Learning, Machine Learning, Computer Vision, and Quantum Computing—providing me with a strong theoretical foundation alongside practical skills in building production ML systems.
